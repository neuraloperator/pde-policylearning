...
from libs.DINo.network import MLP, SetEncoder
from libs.DINo.utils import process_config, count_parameters, set_rdm_seed, create_logger, scheduling, write_image, eval_dino, eval_dino_cond
...
eval_every = 100
# n_epochs = 100  # quick debug
n_epochs = 10000  # our full epoch
# n_epochs = 120000  # original paper, long epoch
