...
mlab.figure(step, bgcolor=(1, 1, 1), fgcolor=(0.,0.,0.), size=(800, 600))
print(np.unravel_index(np.argmax(discriminant), discriminant.shape))
mlab.contour3d(discriminant, contours=[5e-5], opacity=0.2, colormap='viridis')
...
# Add axes
mlab.axes(color=(0, 0, 0), line_width=1.5)
mlab.xlabel('x')
mlab.ylabel('y')
mlab.zlabel('z')
